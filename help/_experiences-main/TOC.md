...
+ [!DNL Analytics] por Você {#analytics}
   ...
   + Introdução a [!DNL Analytics] {#intro-to-analytics}
   ...
   + Administração {#administration}
      ...
      + Dicas e Práticas Recomendadas do Administrador {#admin-tips}
         ...
         + [Criar um site  [!DNL Adobe Analytics]  interno](../analytics/administration/admin-tips/create-an-internal-adobe-analytics-site.md)
...
+ [!DNL Campaign] por Você {#campaign}
   ...
   + Estratégia e liderança de pensamento{#strategy}
      + [Dez práticas recomendadas para o sucesso do  [!DNL Adobe Campaign]  para profissionais de marketing](/help/campaign/10-best-practices-for-marketers.md)
+ Experience Manager por Você {#experience-manager}
   ...
   + AEM as a Cloud Service {#cloud-service}
      + [Manual de integração do [!DNL Cloud Manager]](/help/experience-manager/cloud-service/expert-resources/aem-champions/onboarding-playbook.md)
      ...
      + [IU [!DNL Cloud Manager]](/help/experience-manager/cloud-service/expert-resources/aem-champions/cloud-manager-ui.md)
      + Práticas recomendadas {#cloud-manager-best-practices}
         ...
         + [Estratégias e dicas de migração do Post](/help/experience-manager/cloud-service/expert-resources/aem-champions/post-migration.md)
         ...
         + [Como lidar com desafios ao migrar para o AEM as a Cloud Service](/help/experience-manager/cloud-service/expert-resources/aem-champions/migration-challenges.md)
