...
### Etapa 1: Tornando-se um especialista [!DNL Marketo Engage]

Como administrador, você deve começar por mergulhar nos recursos do [!DNL Marketo Engage], como a Comunidade da Nação de Marketing e a documentação. Durante as fases de avaliação e implementação, leia e explore regularmente esses materiais para criar seu conhecimento.
...
* *Desenvolvimento de módulos de treinamento:* depois de adquirir proficiência, concentre-se na criação de módulos de treinamento personalizados para seus parceiros de negócios de marketing. Crie módulos específicos adaptados a diferentes aspectos do Marketo Engage, usando a amostra abaixo para começar a organizar seu currículo de treinamento.
* *Roteiros de Treinamento Interno:* Considere organizar um tour ao estilo de um roteiro para fornecer treinamento diretamente aos parceiros de negócios de marketing.
